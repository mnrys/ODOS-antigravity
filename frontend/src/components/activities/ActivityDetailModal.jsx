...
export default function ActivityDetailModal({
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-2xl bg-white rounded-[28px] shadow-2xl border border-[#E6E4DF] overflow-hidden flex flex-col max-h-[90vh] animate-scale-up">
        {/* 1. En-tête de la modale */}
        <div className="px-5 py-4 bg-[#F7F6F3] border-b border-[#E6E4DF] flex items-center justify-between gap-3 shrink-0">
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="min-w-0">
              <span className="text-xs font-extrabold text-[#17181A] truncate block uppercase tracking-wider">
                {activity?.categorie_nom || 'Activité'}
              </span>
              {activity?.destination_nom && (
                <span className="text-[11px] font-semibold text-[#55565A] truncate block">
          ...
          <div className="flex items-center gap-2">
            ...
            {onEdit && activity && (
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#17181A] hover:bg-[#3F7A55] text-white text-xs font-bold transition-colors shadow-xs"
            ...
            <button
              type="button"
              onClick={onClose}
              className="w-8 h-8 rounded-full bg-white hover:bg-[#E6E4DF] text-[#55565A] hover:text-[#17181A] flex items-center justify-center transition-colors shadow-xs"
        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-5">
          {loading && !activity ? (
            <div className="py-20 text-center text-sm font-bold text-[#8E8F92]">
            ...
            <>
              ...
              <div>
                <div className="flex flex-wrap items-center gap-2 mb-2">
                  ...
                  {activity.statut === 'reserve' ? (
                    <span className="px-2.5 py-0.5 rounded-full text-[11px] font-extrabold bg-[#EBF5EE] text-[#3F7A55] border border-[#CDE5D4] flex items-center gap-1">
                      <CheckCircle2 className="w-3.5 h-3.5" />
                      <span>Réservé</span>
                    </span>
                  ) : (
                    <span className="px-2.5 py-0.5 rounded-full text-[11px] font-extrabold bg-[#FAF3E7] text-[#B9862F] border border-[#E8D4B0]">
                      À réserver / Option
                    </span>
                  )}

                  {activity.est_placée && (
                    <span className="px-2.5 py-0.5 rounded-full text-[11px] font-extrabold bg-[#EBF5EE] text-[#3F7A55] border border-[#CDE5D4]">
                      ✓ Placé au planning
                    </span>
                  )}
                </div>

                <h2 className="text-xl sm:text-2xl font-extrabold text-[#17181A] leading-snug">
                  {activity.titre}
                </h2>

                {activity.zone_geo && (
                  <div className="flex items-center gap-1 text-xs font-bold text-[#55565A] mt-1.5">
              ...
              <div className="grid grid-cols-3 gap-2.5 p-3.5 rounded-2xl bg-[#F7F6F3] border border-[#E6E4DF]">
                ...
                <div className="flex flex-col">
                  ...
                  {activity.cout_par_personne > 0 && (
                    <span className="text-[10px] text-[#8E8F92]">
              ...
              {(activity.numero_reference ||
                ...
                activity.adresse) && (
                <div className="p-4 rounded-2xl border border-[#E6E4DF] bg-[#FAF9F7] space-y-2.5 text-xs">
                  ...
                  {activity.numero_reference && (
                    <div className="flex items-center justify-between py-1 border-b border-[#E6E4DF]">
                      <span className="text-[#55565A] font-medium">N° de réservation :</span>
                      <span className="font-bold font-mono text-[#17181A] bg-white px-2 py-0.5 rounded border border-[#E6E4DF]">
                        {activity.numero_reference}
                      </span>
                    </div>
                  )}
                  ...
                  {activity.horaires_ouverture && (
                    <div className="flex items-start justify-between py-1 border-b border-[#E6E4DF]">
                  ...
                  {activity.adresse && (
                    <div className="flex items-start justify-between py-1">
                      ...
                      <a
                        ...
                        className="font-bold text-[#3F7A55] hover:underline text-right max-w-[240px] truncate flex items-center gap-1"
              ...
              <div>
                <h4 className="text-xs font-extrabold uppercase tracking-wider text-[#55565A] mb-1.5">
                  Description
                </h4>
                <div className="p-4 rounded-2xl bg-white border border-[#E6E4DF] text-xs text-[#17181A] leading-relaxed whitespace-pre-wrap">
                ...
                <div className="p-4 rounded-2xl bg-[#F0F7F3] border border-[#CDE5D4] space-y-2">
                  <div className="flex items-center justify-between">
                    <h4 className="text-xs font-extrabold text-[#254A33] flex items-center gap-1.5">
                      <MessageSquare className="w-3.5 h-3.5 text-[#3F7A55]" />
                      <span>Synthèse des avis voyageurs</span>
                    </h4>
                    {activity.rating && (
                      <span className="px-2 py-0.5 rounded-full bg-white text-[#3F7A55] text-[11px] font-extrabold border border-[#CDE5D4]">
                  ...
                  {activity.lien_avis_tripadvisor && (
                    <div className="pt-2 border-t border-[#CDE5D4]/60 flex items-center justify-between">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-xs font-bold text-[#3F7A55] hover:text-[#17181A] inline-flex items-center gap-1 hover:underline transition-colors"
                      >
              ...
              {activity.remarques && (
                <div>
                  <h4 className="text-xs font-extrabold uppercase tracking-wider text-[#A4553A] mb-1.5">
                    Remarques & Conseils personnels
                  </h4>
                  <div className="p-4 rounded-2xl bg-[#FFF9F2] border border-[#F5E5D3] text-xs text-[#A4553A] leading-relaxed whitespace-pre-wrap">
                    {activity.remarques}
                  </div>
                </div>
              )}
              ...
              {activity.url_source && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3.5 rounded-2xl border border-[#E6E4DF] bg-[#FAF9F7] hover:border-[#17181A] hover:bg-white transition-all flex items-center justify-between text-xs font-bold text-[#17181A] group"
                >
        ...
        <div className="px-5 py-3.5 bg-[#F7F6F3] border-t border-[#E6E4DF] flex items-center justify-between gap-3 shrink-0">
          <button
            type="button"
            onClick={onClose}
            className="px-5 py-2.5 rounded-full bg-white hover:bg-[#E6E4DF] text-[#17181A] text-xs font-extrabold border border-[#E6E4DF] transition-colors shadow-xs"
          >
            Fermer
          </button>
          ...
          {onEdit && activity && (
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#17181A] hover:bg-[#3F7A55] text-white text-xs font-extrabold transition-colors shadow-sm"
            >
